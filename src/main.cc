...
#include <fmt/core.h>
#include <imgui.h>
#include <imgui_bindings/imgui_impl_sdl.h> // TODO : Use this with Vulkan
// #include <imgui_bindings/imgui_impl_sdlrenderer.h>
...
int main(int argc, char* argv[])
{
    ...
    //     two flags. SDL_Event event; while (SDL_PollEvent(&event)) {
    ...
    //     code to learn more about Dear ImGui!). if (show_demo_window)
    ...
    //         ImGui::Begin("Another Window", &show_another_window); // Pass a pointer to our bool variable (the window
    //         will have a closing button that will clear the bool when clicked) ImGui::Text("Hello from another
    ...
    //     (Uint8)(clear_color.z * 255), (Uint8)(clear_color.w * 255)); SDL_RenderClear(renderer);
